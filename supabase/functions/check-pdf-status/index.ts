    ...
    if (statusData.status === 'completed') {
      ...
      return new Response(
        JSON.stringify({
          ...
          message:
            statusData.message ||
            (statusData.success
              ? 'PDF processing completed and questions saved'
              : 'Processing completed with issues or questions could not be saved.'),
      ...
      return new Response(
        JSON.stringify({
          ...
          message:
            statusData.message || 'Processing completed with warnings (e.g., no questions found).',
          data: statusData.data || {},
