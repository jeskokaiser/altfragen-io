                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-slate-600">Universität Hamburg (UKE)</span>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                      <span className="text-sm font-medium text-slate-900">D1 Modulabschlussklausur</span>
                      <span className="text-xs text-blue-600 bg-blue-100 px-2 py-1 rounded">542 Fragen</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                      <span className="text-sm font-medium text-slate-900">B2 Modulabschlussklausur</span>
                      <span className="text-xs text-purple-600 bg-purple-100 px-2 py-1 rounded">653 Fragen</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                      <span className="text-sm font-medium text-slate-900">F3 Modulabschlussklausur</span>
                      <span className="text-xs text-green-600 bg-green-100 px-2 py-1 rounded">1011 Fragen</span>
                    </div>
                  </div>
                  <div className="mt-4 pt-4 border-t border-slate-200">
                    <p className="text-xs text-slate-500 text-center">
                      Insgesamt 8578 geteilte Fragen verfügbar
                    </p>
                  </div>
                </div>
                {/* Floating elements */}
