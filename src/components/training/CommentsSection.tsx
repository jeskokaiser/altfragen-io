...
const CommentsSection: React.FC<CommentsSectionProps> = ({ questionId, questionVisibility }) => {
  const { user } = useAuth();
  const queryClient = useQueryClient();

  const allowPublicComments =
    questionVisibility === 'university' || questionVisibility === 'public';
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8 text-destructive">Fehler beim Laden der Notizen</div>
        ) : (
