      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="p-4 rounded-lg border bg-card text-card-foreground shadow-sm">
          ...
          <Progress value={correctPercentageBar} className="h-2 mb-2 bg-green-100 dark:bg-green-950/50">
            <div className="h-full bg-green-600 transition-all dark:bg-green-600/50" style={{ width: `${correctPercentageBar}%` }} />
          </Progress>
          <p className="text-sm text-muted-foreground">
        ...
        <div className="p-4 rounded-lg border bg-card text-card-foreground shadow-sm">
          ...
          <Progress value={wrongPercentageBar} className="h-2 mb-2 bg-red-100 dark:bg-red-950/50">
            <div className="h-full bg-red-600 transition-all dark:bg-red-600/50" style={{ width: `${wrongPercentageBar}%` }} />
          </Progress>
          <p className="text-sm text-muted-foreground">
