          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-slate-300 hover:border-slate-400 hover:bg-slate-50 text-slate-700 px-8 py-6 text-lg"
              >
                Wie es funktioniert
              </Button>
            </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-slate-50 to-white rounded-xl p-8 shadow-lg border border-slate-100">
          <div className="flex flex-col items-center text-center">
            ...
            <blockquote className="text-xl md:text-2xl font-medium text-slate-700 mb-6">
              "Mit Altfragen.io konnte ich meine Prüfungsvorbereitung deutlich effizienter gestalten. Die Plattform hat mir geholfen, meine Schwächen zu identifizieren und gezielt zu verbessern."
            </blockquote>
            <cite className="text-slate-500 font-medium">
              - Anna M., Medizinstudentin
            </cite>
          </div>
        </div>
      </section>
...
const FeatureCard = ({ icon, title, description, color }: { 
  ...
  return (
    <div className={cn(
      "p-6 rounded-xl bg-gradient-to-br shadow-sm hover:shadow-md transition-all duration-300 border transform hover:-translate-y-1",
      getGradient()
    )}>
