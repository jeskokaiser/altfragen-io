          ...
          <CardContent className="space-y-6">
            ...
            <section className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="mb-3">
                  Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (Jesko Kaiser, Kegelhofstr. 17,
                  20251 Hamburg, E-Mail: hallo@altfragen.io) mittels einer eindeutigen Erklärung
                  (z.B E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren. Sie
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                ...
                <p className="mb-3">
                  <strong>Wichtiger Hinweis:</strong> Wenn Sie ausdrücklich zugestimmt haben, dass
                  wir mit der Ausführung der Dienstleistung vor Ablauf der Widerrufsfrist beginnen,
                  und Sie zur Kenntnis genommen haben, dass Sie durch Ihre Zustimmung mit Beginn der
                  Ausführung der Dienstleistung Ihr Widerrufsrecht verlieren, erlischt Ihr
                  Widerrufsrecht.
                </p>
                <p>
                  Dies gilt insbesondere für die Nutzung unserer Premium-KI-Funktionen nach
                  Vertragsabschluss.
                </p>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="bg-gray-50 p-6 rounded-lg border-2 border-dashed border-gray-300">
                ...
                <p className="mb-4">Bestellt am (*)/erhalten am (*): _________________</p>

                <p className="mb-4">Name des/der Verbraucher(s): _________________</p>

                <p className="mb-4">Anschrift des/der Verbraucher(s): _________________</p>
            ...
            <section className="space-y-2">
              ...
              <p>Für Widerrufe und Fragen zum Widerrufsrecht kontaktieren Sie uns:</p>
