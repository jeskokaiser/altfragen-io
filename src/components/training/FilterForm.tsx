...
const FilterForm = forwardRef<FilterFormRef, FilterFormProps>(
  ({ subjects, years, onSubmit, onChange }, ref) => {
    ...
    const maxYear =
      numericYears.length > 0 ? numericYears[numericYears.length - 1] : new Date().getFullYear();
            ...
            <div className="flex items-center space-x-2">
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>
                      Bei zufälliger Auswahl werden die Filter für Fach, Jahr und Semester ignoriert
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
                  ...
                  <TooltipTrigger asChild>
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          form.setValue('excludeTodaysQuestions', checked)
                        }
                        id="exclude-todays-questions"
                        disabled={isRandomMode}
                      />
                      <Label htmlFor="exclude-todays-questions">
                        Nur Fragen die ich heute noch nicht hatte
                      </Label>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                  ...
                  <TooltipTrigger asChild>
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          form.setValue('questionsWithImagesOnly', checked)
                        }
              ...
              <div className="flex items-center space-x-2">
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>
                        Sortiert Fragen nach Anzahl der Versuche
                        {newQuestionsOnly ? ' (nicht verfügbar bei neuen Fragen)' : ''}
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
